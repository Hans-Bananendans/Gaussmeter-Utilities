...
Notes on processing:
 ...
 - The merged downsampled file and the 2500 Hz split files should be kept, but
    the 100 Hz split files can be deleted
"""
...
# Base filename
filename_base = "./data/Weekday2500Hz_LightsOn_2023-07-05_11.46.50.dat"
...
# Delete any files whose filenames include "_sXXofXX_SPARSE25.dat" can be
